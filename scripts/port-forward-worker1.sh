#!/bin/bash
# Port forwarding script for Worker1 node (161.97.182.224)

echo "🔧 Setting up port forwarding on Worker1 node (161.97.182.224)..."
...
echo "✅ Port forwarding configured on Worker1:"
...
if [ "$RESPONSE" = "302" ] || [ "$RESPONSE" = "200" ]; then
    echo "✅ Worker1 node: Working (Status: $RESPONSE)"
    echo "🌐 Access: http://161.97.182.224/analytics"
else
